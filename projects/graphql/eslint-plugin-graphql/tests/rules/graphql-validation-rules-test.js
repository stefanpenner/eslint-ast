...
tester.run('ExecutableDefinitionsRule', plugin.rules.ExecutableDefinitionsRule, {
  valid: [`fragment Foo on Apple { id }`],
  invalid: [
    {
...
fragment Fragment on Dog {
  ...
  nom: nickname
      ...
      errors: [
        {
          message:
            'Fields "nom" conflict because "name" and "nickname" are different fields. Use different aliases on the fields to fetch both if this was intentional.',
          line: 3,
          column: 4,
          type: 'Field',
          endLine: 3,
